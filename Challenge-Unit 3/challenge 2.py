'''
3.2 Implement a function called sort_students that takes a list of student objects as input and sorts the 
...
students = [
    ...
    Student("Sakthi", "A124", 8.9),
    Student("Ravi", "A125", 9.1),
    Student("Bharadhi", "A126", 9.9)
]
